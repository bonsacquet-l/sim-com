...
Fct_Graph_Detect_D2D4_par_2_tiff<-function(Detection="D4",couleur_noir="couleur",
  ...
  if(couleur_noir=="couleur") {
    ...
    saveData<-file.path("Outcome","out-graph",
                        paste("MoreLess_Detect_tt_",Detection,"_",graph_1,"_",graph_2,"_noir_blanc_L.tiff",sep=""))}
  ...
  mtext(text =text_1, side=1, line = 5, at=-12, las=1 ,cex = 1.3)
  ...
  mtext(text =text_2, side=1, line = 5, at=-12, las=1 ,cex = 1.3)
