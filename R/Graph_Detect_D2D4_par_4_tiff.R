...
Fct_Graph_Detect_D2D4_par_4_tiff<-function(Detection="D4",couleur_noir="couleur",
  ...
  if (graph_3=="ACP"){
    load(file.path("Outcome","out-regroupement","ACP","ACP_Grp_Detect_good.Rdata"))
    M_Grp_Detect_Axe1_G3<-M_Grp_Detect_Axe1_ACP_good
    M_Grp_Detect_Axe1_Naive_G3<-M_Grp_Detect_Axe1_ACP_Naive_good
    M_Grp_Detect_Axe2_G3<-M_Grp_Detect_Axe2_ACP_good
    M_Grp_Detect_Axe2_Naive_G3<-M_Grp_Detect_Axe2_ACP_Naive_good
    text_3<-"PCA"
  }
  
  if (graph_3=="AFC"){
    load(file.path("Outcome","out-regroupement","AFC","AFC_Grp_Detect_good.Rdata"))
    M_Grp_Detect_Axe1_G3<-M_Grp_Detect_Axe1_AFC_good
    M_Grp_Detect_Axe1_Naive_G3<-M_Grp_Detect_Axe1_AFC_Naive_good
    M_Grp_Detect_Axe2_G3<-M_Grp_Detect_Axe2_AFC_good
    M_Grp_Detect_Axe2_Naive_G3<-M_Grp_Detect_Axe2_AFC_Naive_good
    text_3<-"CA"
  }
  
  if (graph_3=="PCoA_bray"){
    load(file.path("Outcome","out-regroupement","PCoA","PCoA_bray_Grp_Detect_good.Rdata"))
    M_Grp_Detect_Axe1_G3<-M_Grp_Detect_Axe1_pcoa_good
    M_Grp_Detect_Axe1_Naive_G3<-M_Grp_Detect_Axe1_pcoa_Naive_good
    M_Grp_Detect_Axe2_G3<-M_Grp_Detect_Axe2_pcoa_good
    M_Grp_Detect_Axe2_Naive_G3<-M_Grp_Detect_Axe2_pcoa_Naive_good
    text_3<-graph_3
  }
  ...
  if (graph_3=="nMDS_bray"){
    load(file.path("Outcome","out-regroupement","nMDS","nMDS_bray_Grp_Detect_good.Rdata"))
    M_Grp_Detect_Axe1_G3<-M_Grp_Detect_Axe1_nmds_good
    M_Grp_Detect_Axe1_Naive_G3<-M_Grp_Detect_Axe1_nmds_Naive_good
    M_Grp_Detect_Axe2_G3<-M_Grp_Detect_Axe2_nmds_good
    M_Grp_Detect_Axe2_Naive_G3<-M_Grp_Detect_Axe2_nmds_Naive_good
    text_3<-graph_3
  }
  ...
  if (graph_4=="ACP"){
    load(file.path("Outcome","out-regroupement","ACP","ACP_Grp_Detect_good.Rdata"))
    M_Grp_Detect_Axe1_G4<-M_Grp_Detect_Axe1_ACP_good
    M_Grp_Detect_Axe1_Naive_G4<-M_Grp_Detect_Axe1_ACP_Naive_good
    M_Grp_Detect_Axe2_G4<-M_Grp_Detect_Axe2_ACP_good
    M_Grp_Detect_Axe2_Naive_G4<-M_Grp_Detect_Axe2_ACP_Naive_good
    text_4<-"PCA"
  }
  
  if (graph_4=="AFC"){
    load(file.path("Outcome","out-regroupement","AFC","AFC_Grp_Detect_good.Rdata"))
    M_Grp_Detect_Axe1_G4<-M_Grp_Detect_Axe1_AFC_good
    M_Grp_Detect_Axe1_Naive_G4<-M_Grp_Detect_Axe1_AFC_Naive_good
    M_Grp_Detect_Axe2_G4<-M_Grp_Detect_Axe2_AFC_good
    M_Grp_Detect_Axe2_Naive_G4<-M_Grp_Detect_Axe2_AFC_Naive_good
    text_4<-"CA"
  }
  
  if (graph_4=="PCoA_bray"){
    load(file.path("Outcome","out-regroupement","PCoA","PCoA_bray_Grp_Detect_good.Rdata"))
    M_Grp_Detect_Axe1_G4<-M_Grp_Detect_Axe1_pcoa_good
    M_Grp_Detect_Axe1_Naive_G4<-M_Grp_Detect_Axe1_pcoa_Naive_good
    M_Grp_Detect_Axe2_G4<-M_Grp_Detect_Axe2_pcoa_good
    M_Grp_Detect_Axe2_Naive_G4<-M_Grp_Detect_Axe2_pcoa_Naive_good
    text_4<-graph_4
  }
  ...
  if (graph_4=="nMDS_bray"){
    load(file.path("Outcome","out-regroupement","nMDS","nMDS_bray_Grp_Detect_good.Rdata"))
    M_Grp_Detect_Axe1_G4<-M_Grp_Detect_Axe1_nmds_good
    M_Grp_Detect_Axe1_Naive_G4<-M_Grp_Detect_Axe1_nmds_Naive_good
    M_Grp_Detect_Axe2_G4<-M_Grp_Detect_Axe2_nmds_good
    M_Grp_Detect_Axe2_Naive_G4<-M_Grp_Detect_Axe2_nmds_Naive_good
    text_4<-graph_4
  }
  ...
  if(couleur_noir=="couleur") {
    saveData<-file.path("Outcome","out-graph",
                        paste("MoreLess_Detect_",graph_1,"_",graph_2,"_",graph_3,"_",graph_4,"_",Detection,"_couleur.tiff",sep=""))
  } else {
    saveData<-file.path("Outcome","out-graph",
                        paste("MoreLess_Detect_",graph_1,"_",graph_2,"_",graph_3,"_",graph_4,"_",Detection,"_noir_blanc.tiff",sep=""))
    }
  ...
  # les graphiques #
  #----------------#
  tiff(file=saveData, units="in", width = 10.1, height = 13, pointsize = 9,res=300)
  ...
  mtext(text ="a", side=2, line = 3, at=ylimG1_1[2], las=2 ,cex = 2.2)
  ...
  mtext(text =text_1, side=1, line = 5, at=-10, las=1 ,cex = 1.7)
  ...
  axis(1,at=c(35.5,41,46.5),labels = c("","C4",""),col=couleur_Axis[4],
       col.axis=couleur_Axis[4],lwd=0.7,cex.axis=1.3)
  mtext(text ="b", side=2, line = 3, at=ylimG2_1[2], las=2 ,cex = 2.2)
  abline(h=0,col="black",lty=2,lwd=0.5)
  ...
  mtext(text =text_2, side=1, line = 5, at=-10, las=1 ,cex = 1.7)
  ...
  #- axe 1 informed data
  par(mar=c(6,5,0.5,1))
  boxplot(M_Grp_Detect_Axe1_G3[,colonnes],
          ylim=ylimG3_1,
          col=couleur, border=bordure,outline=FALSE,
          cex.axis=1.6,
          xlab=xlab9,
  ...
  axis(1,at=c(35.5,41,46.5),labels = c("","C4",""),col=couleur_Axis[4],
       col.axis=couleur_Axis[4],lwd=0.7,cex.axis=1.3)
  mtext(text ="c", side=2, line = 3, at=ylimG3_1[2], las=2 ,cex = 2.2)
  abline(h=0,col="black",lty=2,lwd=0.5)
  
  #- axe 1 naive data
  par(mar=c(6,5,0.5,1))
  boxplot(M_Grp_Detect_Axe1_Naive_G3[,colonnes],
          ylim=ylimG3_2,
          col=couleur, border=bordure,outline=FALSE,
          cex.axis=1.6,
          xlab=xlab10,
  ...
  #- axe 2 informed data
  par(mar=c(6,5,0.5,1))
  boxplot(M_Grp_Detect_Axe2_G3[,colonnes],
          ylim=ylimG3_3,
          col=couleur, border=bordure,outline=FALSE,
          cex.axis=1.6,
          xlab=xlab11,
  ...
  #- axe 2 naive data
  par(mar=c(6,5,0.5,1))
  boxplot(M_Grp_Detect_Axe2_Naive_G3[,colonnes],
          ylim=ylimG3_4,
          col=couleur, border=bordure,outline=FALSE,
          cex.axis=1.6,
          xlab=xlab12,
  ...
  mtext(text =text_3, side=1, line = 5, at=-10, las=1 ,cex = 1.7)
  ...
  #- axe 1 informed data
  par(mar=c(6,5,0.5,1))
  boxplot(M_Grp_Detect_Axe1_G4[,colonnes],
          ylim=ylimG4_1,
          col=couleur, border=bordure,outline=FALSE,
          cex.axis=1.6,
          xlab=xlab13,
  ...
  axis(1,at=c(35.5,41,46.5),labels = c("","C4",""),col=couleur_Axis[4],
       col.axis=couleur_Axis[4],lwd=0.7,cex.axis=1.3)
  mtext(text ="d", side=2, line = 3, at=ylimG4_1[2], las=2 ,cex = 2.2)
  abline(h=0,col="black",lty=2,lwd=0.5)
  
  #- axe 1 naive data
  par(mar=c(6,5,0.5,1))
  boxplot(M_Grp_Detect_Axe1_Naive_G4[,colonnes],
          ylim=ylimG4_2,
          col=couleur, border=bordure,outline=FALSE,
          cex.axis=1.6,
          xlab=xlab14,
  ...
  #- axe 2 informed data
  par(mar=c(6,5,0.5,1))
  boxplot(M_Grp_Detect_Axe2_G4[,colonnes],
          ylim=ylimG4_3,
          col=couleur, border=bordure,outline=FALSE,
          cex.axis=1.6,
          xlab=xlab15,
  ...
  #- axe 2 naive data
  par(mar=c(6,5,0.5,1))
  boxplot(M_Grp_Detect_Axe2_Naive_G4[,colonnes],
          ylim=ylimG4_4,
          col=couleur, border=bordure,outline=FALSE,
          cex.axis=1.6,
          xlab=xlab16,
  ...
  mtext(text =text_4, side=1, line = 5, at=-10, las=1 ,cex = 1.7)
