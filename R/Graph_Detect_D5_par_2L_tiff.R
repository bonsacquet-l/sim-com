...
Fct_Graph_Detect_D5_par_2_tiff<-function(Detection="D5",couleur_noir="couleur",
  ...
  if(couleur_noir=="couleur") {
    saveData<-file.path("Outcome","out-graph",
                        paste("MoreLess_Detect_",Detection,"_",graph_1,"_",graph_2,"_couleur_L.tiff",sep=""))
  } else {
    saveData<-file.path("Outcome","out-graph",
                        paste("MoreLess_Detect_",Detection,"_",graph_1,"_",graph_2,"_noir_blanc_L.tiff",sep=""))}
  ...
  title(ylab="axis1, more/less detectable",line = 3,cex.lab=1.8, adj=0.5)
  ...
  boxplot(M_Grp_Detect_Axe2_G1[,colonnes],
          ...
          xlab=xlab3,
          xaxt="n",lwd=0.5,cex.lab=1.8,at=espbox)
  title(ylab="axis2, more/less detectable",line = 3,cex.lab=1.8, adj=0.5)
  axis(1,at=c(0.5,1.75,3),labels = c("","C1",""),col=couleur_Axis[1],
       col.axis=couleur_Axis[1],lwd=0.7,cex.axis=1.3)
  axis(1,at=c(3,4.5,6),labels = c("","C2",""),col=couleur_Axis[2],
       col.axis=couleur_Axis[2],lwd=0.7,cex.axis=1.3)
  ...
  axis(1,at=c(9,10.25,11.5),labels = c("","C4",""),col=couleur_Axis[4],
       col.axis=couleur_Axis[4],lwd=0.7,cex.axis=1.3)
  mtext(text ="b", side=2, line = 3.5, at=ylimG2_1[2], las=2 ,cex = 1.8)
  abline(h=0,col="black",lty=2,lwd=0.5)
