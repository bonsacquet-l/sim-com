...
Fct_Graph_G1_G2_par_2_tiff<-function(Detection="D1",couleur_noir="couleur",
  ...
  if(couleur_noir=="couleur") {
    saveData<-file.path("Outcome","out-graph",
                        paste("G1_G2_",Detection,"_",graph_1,"_",graph_2,"_couleur_L.tiff",sep=""))
  } else {
    saveData<-file.path("Outcome","out-graph",
                        paste("G1_G2_",Detection,"_",graph_1,"_",graph_2,"_noir_blanc_L.tiff",sep=""))}
  ...
  if (Detection!="D5") {
    ...
    title(ylab="axis1, groups 1 & 2",line = 3,cex.lab=1.8, adj=0.5)
    ...
    mtext(text ="a", side=2, line = 3.5, at=ylimG1_1[2], las=2 ,cex = 1.8)
    ...
    boxplot(M_Grp_1_2_Axe2_G1[,colonnes],
            ...
            xlab=xlab3,
            xaxt="n",lwd=0.5,cex.lab=1.8,at=espbox)
    title(ylab="axis2, groups 1 & 2",line = 3,cex.lab=1.8, adj=0.5)
    axis(1,at=c(0.5,6,11.5),labels = c("","C1",""),col=couleur_Axis[1],
         col.axis=couleur_Axis[1],lwd=0.7,cex.axis=1.3)
    axis(1,at=c(11.5,17.5,23.5),labels = c("","C2",""),col=couleur_Axis[2],
         col.axis=couleur_Axis[2],lwd=0.7,cex.axis=1.3)
