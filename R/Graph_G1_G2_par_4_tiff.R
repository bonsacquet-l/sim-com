...
Fct_Graph_G1_G2_par_4_tiff<-function(Detection="D1",couleur_noir="couleur",
  ...
  if (graph_3=="ACP"){
    load(file.path("Outcome","out-regroupement","ACP","ACP_Grp_1_2_good.Rdata"))
    M_Grp_1_2_Axe1_G3<-M_Grp_1_2_Axe1_ACP_good
    M_Grp_1_2_Axe1_Naive_G3<-M_Grp_1_2_Axe1_ACP_Naive_good
    M_Grp_1_2_Axe2_G3<-M_Grp_1_2_Axe2_ACP_good
    M_Grp_1_2_Axe2_Naive_G3<-M_Grp_1_2_Axe2_ACP_Naive_good
    text_3<-"PCA"
  }
  
  if (graph_3=="AFC"){
    load(file.path("Outcome","out-regroupement","AFC","AFC_Grp_1_2_good.Rdata"))
    M_Grp_1_2_Axe1_G3<-M_Grp_1_2_Axe1_AFC_good
    M_Grp_1_2_Axe1_Naive_G3<-M_Grp_1_2_Axe1_AFC_Naive_good
    M_Grp_1_2_Axe2_G3<-M_Grp_1_2_Axe2_AFC_good
    M_Grp_1_2_Axe2_Naive_G3<-M_Grp_1_2_Axe2_AFC_Naive_good
    text_3<-"CA"
  }
  
  if (graph_3=="PCoA_bray"){
    load(file.path("Outcome","out-regroupement","PCoA","PCoA_bray_Grp_1_2_good.Rdata"))
    M_Grp_1_2_Axe1_G3<-M_Grp_1_2_Axe1_pcoa_good
    M_Grp_1_2_Axe1_Naive_G3<-M_Grp_1_2_Axe1_pcoa_Naive_good
    M_Grp_1_2_Axe2_G3<-M_Grp_1_2_Axe2_pcoa_good
    M_Grp_1_2_Axe2_Naive_G3<-M_Grp_1_2_Axe2_pcoa_Naive_good
    text_3<-graph_3
  }
  ...
  if (graph_3=="nMDS_bray"){
    load(file.path("Outcome","out-regroupement","nMDS","nMDS_bray_Grp_1_2_good.Rdata"))
    M_Grp_1_2_Axe1_G3<-M_Grp_1_2_Axe1_nmds_good
    M_Grp_1_2_Axe1_Naive_G3<-M_Grp_1_2_Axe1_nmds_Naive_good
    M_Grp_1_2_Axe2_G3<-M_Grp_1_2_Axe2_nmds_good
    M_Grp_1_2_Axe2_Naive_G3<-M_Grp_1_2_Axe2_nmds_Naive_good
    text_3<-graph_3
  }
  ...
  if (graph_4=="ACP"){
    load(file.path("Outcome","out-regroupement","ACP","ACP_Grp_1_2_good.Rdata"))
    M_Grp_1_2_Axe1_G4<-M_Grp_1_2_Axe1_ACP_good
    M_Grp_1_2_Axe1_Naive_G4<-M_Grp_1_2_Axe1_ACP_Naive_good
    M_Grp_1_2_Axe2_G4<-M_Grp_1_2_Axe2_ACP_good
    M_Grp_1_2_Axe2_Naive_G4<-M_Grp_1_2_Axe2_ACP_Naive_good
    text_4<-"PCA"
  }
  
  if (graph_4=="AFC"){
    load(file.path("Outcome","out-regroupement","AFC","AFC_Grp_1_2_good.Rdata"))
    M_Grp_1_2_Axe1_G4<-M_Grp_1_2_Axe1_AFC_good
    M_Grp_1_2_Axe1_Naive_G4<-M_Grp_1_2_Axe1_AFC_Naive_good
    M_Grp_1_2_Axe2_G4<-M_Grp_1_2_Axe2_AFC_good
    M_Grp_1_2_Axe2_Naive_G4<-M_Grp_1_2_Axe2_AFC_Naive_good
    text_4<-"CA"
  }
  
  if (graph_4=="PCoA_bray"){
    load(file.path("Outcome","out-regroupement","PCoA","PCoA_bray_Grp_1_2_good.Rdata"))
    M_Grp_1_2_Axe1_G4<-M_Grp_1_2_Axe1_pcoa_good
    M_Grp_1_2_Axe1_Naive_G4<-M_Grp_1_2_Axe1_pcoa_Naive_good
    M_Grp_1_2_Axe2_G4<-M_Grp_1_2_Axe2_pcoa_good
    M_Grp_1_2_Axe2_Naive_G4<-M_Grp_1_2_Axe2_pcoa_Naive_good
    text_4<-graph_4
  }
  ...
  if (graph_4=="nMDS_bray"){
    load(file.path("Outcome","out-regroupement","nMDS","nMDS_bray_Grp_1_2_good.Rdata"))
    M_Grp_1_2_Axe1_G4<-M_Grp_1_2_Axe1_nmds_good
    M_Grp_1_2_Axe1_Naive_G4<-M_Grp_1_2_Axe1_nmds_Naive_good
    M_Grp_1_2_Axe2_G4<-M_Grp_1_2_Axe2_nmds_good
    M_Grp_1_2_Axe2_Naive_G4<-M_Grp_1_2_Axe2_nmds_Naive_good
    text_4<-graph_4
  }
  ...
  if(couleur_noir=="couleur") {
    saveData<-file.path("Outcome","out-graph",
                        paste("G1_G2_",graph_1,"_",graph_2,"_",graph_3,"_",graph_4,"_",Detection,"_couleur.tiff",sep=""))
  } else {
    saveData<-file.path("Outcome","out-graph",
                        paste("G1_G2_",graph_1,"_",graph_2,"_",graph_3,"_",graph_4,"_",Detection,"_noir_blanc.tiff",sep=""))}
  ...
  if (Detection!="D5") {
    ...
    #- axe 1 informed data
    par(mar=c(4,5,0.5,1))
    boxplot(M_Grp_1_2_Axe1_G3[,colonnes],
            ylim=ylimG3_1,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
            xlab=xlab9,
    ...
    #- axe 1 naive data
    par(mar=c(4,5,0.5,1))
    boxplot(M_Grp_1_2_Axe1_Naive_G3[,colonnes],
            ylim=ylimG3_2,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
            xlab=xlab10,
    ...
    #- axe 2 informed data
    par(mar=c(4,5,0.5,1))
    boxplot(M_Grp_1_2_Axe2_G3[,colonnes],
            ylim=ylimG3_3,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
            xlab=xlab11,
    ...
    #- axe 2 naive data
    par(mar=c(4,5,0.5,1))
    boxplot(M_Grp_1_2_Axe2_Naive_G3[,colonnes],
            ylim=ylimG3_4,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
            xlab=xlab12,
    ...
    #- axe 1 informed data
    par(mar=c(4,5,0.5,1))
    boxplot(M_Grp_1_2_Axe1_G4[,colonnes],
            ylim=ylimG4_1,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
            xlab=xlab13,
    ...
    #- axe 1 naive data
    par(mar=c(4,5,0.5,1))
    boxplot(M_Grp_1_2_Axe1_Naive_G4[,colonnes],
            ylim=ylimG4_2,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
            xlab=xlab14,
    ...
    #- axe 2 informed data
    par(mar=c(4,5,0.5,1))
    boxplot(M_Grp_1_2_Axe2_G4[,colonnes],
            ylim=ylimG4_3,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
            xlab=xlab15,
    ...
    #- axe 2 naive data
    par(mar=c(4,5,0.5,1))
    boxplot(M_Grp_1_2_Axe2_Naive_G4[,colonnes],
            ylim=ylimG4_4,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
            xlab=xlab16,
