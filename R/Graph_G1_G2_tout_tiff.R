...
Fct_Graph_G1_G2_tout_tiff<-function(Detection="D1",couleur_noir="couleur",
                                    ...
                                    ylimPCoAbray1=c(-0.03,0.03),ylimPCoAbray2=c(-0.07,0.07),
                                    ylimPCoAbray3=c(-0.01,0.01),ylimPCoAbray4=c(-0.07,0.07),
                                    ylimnMDSbray1=c(-0.4,0.4),ylimnMDSbray2=c(-0.5,0.5),
                                    ylimnMDSbray3=c(-0.25,0.25),ylimnMDSbray4=c(-0.35,0.35),
                                    ylimPCoAchao1=c(-0.03,0.03),ylimPCoAchao2=c(-0.2,0.2),
                                    ylimPCoAchao3=c(-0.01,0.01),ylimPCoAchao4=c(-0.15,0.15),
                                    ylimnMDSchao1=c(-0.4,0.4),ylimnMDSchao2=c(-0.8,0.8),
                                    ylimnMDSchao3=c(-0.25,0.25),ylimnMDSchao4=c(-0.5,0.5)) {
  ...
  if(couleur_noir=="couleur") {
    saveData<-file.path("Outcome","out-graph",
                        paste("G1_G2_tt_",Detection,"_couleur.tiff",sep=""))
  } else {
    saveData<-file.path("Outcome","out-graph",
                        paste("G1_G2_tt_",Detection,"_noir_blanc.tiff",sep=""))}
  ...
  #-- Si ce n'est pas D5
  if (Detection!="D5") {
    tiff(file=saveData, units="in", width = 15, height = 15, pointsize = 10,res=300)
    ...
    #- axe 2 informed data
    par(mar=c(6,5,0.5,1))
    boxplot(M_Grp_1_2_Axe2_ACP_good[,colonnes],
            ylim=ylimACP3,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
            xlab=paste("(a3) informed data ",Detection,sep=""),
            xaxt="n",lwd=0.5,cex.lab=2.2,at=espbox)
    title(ylab="axis2, groups 1 & 2",line = 3,cex.lab=2.2, adj=0.5)
    axis(1,at=c(0.5,6,11.5),labels = c("","C1",""),col=couleur_Axis[1],
         col.axis=couleur_Axis[1],lwd=0.7,cex.axis=1.4)
    axis(1,at=c(11.5,17.5,23.5),labels = c("","C2",""),col=couleur_Axis[2],
         col.axis=couleur_Axis[2],lwd=0.7,cex.axis=1.4)
    ...
    #- axe 2 naive data
    par(mar=c(6,5,0.5,1))
    boxplot(M_Grp_1_2_Axe2_ACP_Naive_good[,colonnes],
            ylim=ylimACP4,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
    ...
    mtext(text ="PCA", side=1, line = 5, at=-9, las=1 ,cex = 1.5)
    ...
    #- axe 1 informed data
    par(mar=c(6,5,0.5,1))
    boxplot(M_Grp_1_2_Axe1_AFC_good[,colonnes],
            ylim=ylimAFC1,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
    ...
    #- axe 1 naive data
    par(mar=c(6,5,0.5,1))
    boxplot(M_Grp_1_2_Axe1_AFC_Naive_good[,colonnes],
            ylim=ylimAFC2,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
    ...
    #- axe 2 informed data
    par(mar=c(6,5,0.5,1))
    boxplot(M_Grp_1_2_Axe2_AFC_good[,colonnes],
            ylim=ylimAFC3,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
    ...
    #- axe 2 naive data
    par(mar=c(6,5,0.5,1))
    boxplot(M_Grp_1_2_Axe2_AFC_Naive_good[,colonnes],
            ylim=ylimAFC4,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
    ...
    mtext(text ="CA", side=1, line = 5, at=-9, las=1 ,cex = 1.5)
    ...
    #- axe 1 informed data
    par(mar=c(6,5,0.5,1))
    boxplot(M_Grp_1_2_Axe1_pcoa_good[,colonnes],
            ylim=ylimPCoAbray1,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
            xlab=paste("(a1) informed data ",Detection,sep=""),
    ...
    #- axe 1 naive data
    par(mar=c(6,5,0.5,1))
    boxplot(M_Grp_1_2_Axe1_pcoa_Naive_good[,colonnes],
            ylim=ylimPCoAbray2,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
            xlab=paste("(a2) naïve data ",Detection,sep=""),
    ...
    #- axe 2 informed data
    par(mar=c(6,5,0.5,1))
    boxplot(M_Grp_1_2_Axe2_pcoa_good[,colonnes],
            ylim=ylimPCoAbray3,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
            xlab=paste("(a3) informed data ",Detection,sep=""),
    ...
    #- axe 2 naive data
    par(mar=c(6,5,0.5,1))
    boxplot(M_Grp_1_2_Axe2_pcoa_Naive_good[,colonnes],
            ylim=ylimPCoAbray4,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
            xlab=paste("(a4) naive data ",Detection,sep=""),
    ...
    mtext(text ="PCoA_Bray", side=1, line = 5, at=-9, las=1 ,cex = 1.5)
    ...
    #- axe 1 informed data
    par(mar=c(6,5,0.5,1))
    boxplot(M_Grp_1_2_Axe1_nmds_good[,colonnes],
            ylim=ylimnMDSbray1,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
            xlab=paste("(b1) informed data ",Detection,sep=""),
    ...
    #- axe 1 naive data
    par(mar=c(6,5,0.5,1))
    boxplot(M_Grp_1_2_Axe1_nmds_Naive_good[,colonnes],
            ylim=ylimnMDSbray2,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
            xlab=paste("(b2) naïve data ",Detection,sep=""),
    ...
    #- axe 2 informed data
    par(mar=c(6,5,0.5,1))
    boxplot(M_Grp_1_2_Axe2_nmds_good[,colonnes],
            ylim=ylimnMDSbray3,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
            xlab=paste("(b3) informed data ",Detection,sep=""),
    ...
    #- axe 2 naive data
    par(mar=c(6,5,0.5,1))
    boxplot(M_Grp_1_2_Axe2_nmds_Naive_good[,colonnes],
            ylim=ylimnMDSbray4,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
            xlab=paste("(b4) naive data ",Detection,sep=""),
    ...
    mtext(text ="nMDS_Bray", side=1, line = 5, at=-9, las=1 ,cex = 1.5)
    ...
    mtext(text ="PCoA_Chao", side=1, line = 5, at=-9, las=1 ,cex = 1.5)
    ...
    mtext(text ="nMDS_Chao", side=1, line = 5, at=-9, las=1 ,cex = 1.5)
