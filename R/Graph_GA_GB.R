...
Fct_Graph_GA_GB<-function(Detection="D1",couleur_noir="couleur") {
  ...
  if(couleur_noir=="couleur") {
    saveData<-file.path("Outcome","out-graph",
                        paste("GA_GB_",Detection,"_couleur.pdf",sep=""))
  } else {
    saveData<-file.path("Outcome","out-graph",
                        paste("GA_GB_",Detection,"_noir_blanc.pdf",sep=""))}
  ...
  if (Detection!="D5") {
    ...
    boxplot(M_Grp_A_B_Axe1_ACP[,colonnes],
            ylim=c(-1,1),
    ...
    title(ylab="axis1, groups A & B",line = 2,cex.lab=1.5)
    ...
    #- axe 1 naive data
    par(mar=c(4,4.5,0.5,1))
    boxplot(M_Grp_A_B_Axe1_ACP_Naive[,colonnes],
            ylim=c(-1,1),
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1,
    ...
    #- axe 2 informed data
    par(mar=c(4,4.5,0.5,1))
    boxplot(M_Grp_A_B_Axe2_ACP[,colonnes],
            ylim=c(-1,1),
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1,
            xlab=paste("(a3) PCA on informed data ",Detection,sep=""),
            xaxt="n",lwd=0.5,cex.lab=1.5,at=espbox)
    title(ylab="axis2, groups A & B",line = 2,cex.lab=1.5)
    axis(1,at=c(0.5,6,11.5),labels = c("","C1",""),col=couleur_Axis[1],
         col.axis=couleur_Axis[1],lwd=0.7,cex.axis=1)
    axis(1,at=c(11.5,17.5,23.5),labels = c("","C2",""),col=couleur_Axis[2],
         col.axis=couleur_Axis[2],lwd=0.7,cex.axis=1)
    ...
    #- axe 2 naive data
    par(mar=c(4,4.5,0.5,1))
    boxplot(M_Grp_A_B_Axe2_ACP_Naive[,colonnes],
            ylim=c(-1,1),
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1,
    ...
    #- axe 1 informed data
    par(mar=c(4,4.5,0.5,1))
    boxplot(M_Grp_A_B_Axe1_AFC[,colonnes],
            ylim=c(-1.2,1.2),
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1,
    ...
    #- axe 1 naive data
    par(mar=c(4,4.5,0.5,1))
    boxplot(M_Grp_A_B_Axe1_AFC_Naive[,colonnes],
            ylim=c(-1.2,1.2),
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1,
    ...
    #- axe 2 informed data
    par(mar=c(4,4.5,0.5,1))
    boxplot(M_Grp_A_B_Axe2_AFC[,colonnes],
            ylim=c(-0.8,0.8),
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1,
    ...
    #- axe 2 naive data
    par(mar=c(4,4.5,0.5,1))
    boxplot(M_Grp_A_B_Axe2_AFC_Naive[,colonnes],
            ylim=c(-0.8,0.8),
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1,
