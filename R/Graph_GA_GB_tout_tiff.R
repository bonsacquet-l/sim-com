...
Fct_Graph_GA_GB_tout_tiff<-function(Detection="D1",couleur_noir="couleur",
  ...
  if(couleur_noir=="couleur") {
    saveData<-file.path("Outcome","out-graph",
                        paste("GA_GB_tt_",Detection,"_couleur.tiff",sep=""))
  } else {
    saveData<-file.path("Outcome","out-graph",
                        paste("GA_GB_tt_",Detection,"_noir_blanc.tiff",sep=""))}
  ...
  if (Detection!="D5") {
    ...
    #- axe 1 naive data
    par(mar=c(6,5,0.5,1))
    boxplot(M_Grp_A_B_Axe1_ACP_Naive_good[,colonnes],
            ylim=ylimACP2,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
    ...
    #- axe 2 informed data
    par(mar=c(6,5,0.5,1))
    boxplot(M_Grp_A_B_Axe2_ACP_good[,colonnes],
            ylim=ylimACP3,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
            xlab=paste("(a3) informed data ",Detection,sep=""),
            xaxt="n",lwd=0.5,cex.lab=2.2,at=espbox)
    title(ylab="axis2, groups A & B",line = 3,cex.lab=2.2, adj=0.5)
    axis(1,at=c(0.5,6,11.5),labels = c("","C1",""),col=couleur_Axis[1],
         col.axis=couleur_Axis[1],lwd=0.7,cex.axis=1.4)
    axis(1,at=c(11.5,17.5,23.5),labels = c("","C2",""),col=couleur_Axis[2],
         col.axis=couleur_Axis[2],lwd=0.7,cex.axis=1.4)
    ...
    #- axe 2 naive data
    par(mar=c(6,5,0.5,1))
    boxplot(M_Grp_A_B_Axe2_ACP_Naive_good[,colonnes],
            ylim=ylimACP4,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
    ...
    #- axe 1 informed data
    par(mar=c(6,5,0.5,1))
    boxplot(M_Grp_A_B_Axe1_AFC_good[,colonnes],
            ylim=ylimAFC1,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
    ...
    #- axe 1 naive data
    par(mar=c(6,5,0.5,1))
    boxplot(M_Grp_A_B_Axe1_AFC_Naive_good[,colonnes],
            ylim=ylimAFC2,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
    ...
    #- axe 2 informed data
    par(mar=c(6,5,0.5,1))
    boxplot(M_Grp_A_B_Axe2_AFC_good[,colonnes],
            ylim=ylimAFC3,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
    ...
    #- axe 2 naive data
    par(mar=c(6,5,0.5,1))
    boxplot(M_Grp_A_B_Axe2_AFC_Naive_good[,colonnes],
            ylim=ylimAFC4,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
    ...
    #- axe 1 informed data
    par(mar=c(6,5,0.5,1))
    boxplot(M_Grp_A_B_Axe1_pcoa_good[,colonnes],
            ylim=ylimPCoAbray1,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
            xlab=paste("(a1) informed data ",Detection,sep=""),
    ...
    #- axe 1 naive data
    par(mar=c(6,5,0.5,1))
    boxplot(M_Grp_A_B_Axe1_pcoa_Naive_good[,colonnes],
            ylim=ylimPCoAbray2,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
            xlab=paste("(a2) naïve data ",Detection,sep=""),
    ...
    #- axe 2 informed data
    par(mar=c(6,5,0.5,1))
    boxplot(M_Grp_A_B_Axe2_pcoa_good[,colonnes],
            ylim=ylimPCoAbray3,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
            xlab=paste("(a3) informed data ",Detection,sep=""),
    ...
    #- axe 2 naive data
    par(mar=c(6,5,0.5,1))
    boxplot(M_Grp_A_B_Axe2_pcoa_Naive_good[,colonnes],
            ylim=ylimPCoAbray4,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
            xlab=paste("(a4) naive data ",Detection,sep=""),
    ...
    #- axe 1 informed data
    par(mar=c(6,5,0.5,1))
    boxplot(M_Grp_A_B_Axe1_nmds_good[,colonnes],
            ylim=ylimnMDSbray1,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
            xlab=paste("(b1) informed data ",Detection,sep=""),
    ...
    #- axe 1 naive data
    par(mar=c(6,5,0.5,1))
    boxplot(M_Grp_A_B_Axe1_nmds_Naive_good[,colonnes],
            ylim=ylimnMDSbray2,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
            xlab=paste("(b2) naïve data ",Detection,sep=""),
    ...
    #- axe 2 informed data
    par(mar=c(6,5,0.5,1))
    boxplot(M_Grp_A_B_Axe2_nmds_good[,colonnes],
            ylim=ylimnMDSbray3,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
            xlab=paste("(b3) informed data ",Detection,sep=""),
    ...
    #- axe 2 naive data
    par(mar=c(6,5,0.5,1))
    boxplot(M_Grp_A_B_Axe2_nmds_Naive_good[,colonnes],
            ylim=ylimnMDSbray4,
            col=couleur, border=bordure,outline=FALSE,
            cex.axis=1.6,
            xlab=paste("(b4) naive data ",Detection,sep=""),
