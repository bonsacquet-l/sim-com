...
Fct_Graph_RV_Site_par_2_tiff<-function(Detection="D1",
  ...
  saveData_couleur<-file.path("Outcome","out-graph",
                              paste("RV_Site_",graph_1,"_",graph_2,"_",Detection,"_couleur.tiff",sep=""))
  saveData_noir<-file.path("Outcome","out-graph",
                           paste("RV_Site_",graph_1,"_",graph_2,"_",Detection,"_noir_blanc.tiff",sep=""))
