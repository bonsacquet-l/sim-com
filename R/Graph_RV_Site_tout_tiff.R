...
Fct_Graph_RV_Site_tt_tiff<-function(Detection="D1") {
  ...
  saveData_couleur<-file.path("Outcome","out-graph",
                              paste("RV_Site_tt_",Detection,"_couleur.tiff",sep=""))
  saveData_noir<-file.path("Outcome","out-graph",
                           paste("RV_Site_tt_",Detection,"_noir_blanc.tiff",sep=""))
