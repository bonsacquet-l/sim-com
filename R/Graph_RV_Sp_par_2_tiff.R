...
Fct_Graph_RV_Sp_par_2_tiff<-function(Detection="D1",
  ...
  saveData_couleur<-file.path("Outcome","out-graph",
                              paste("RV_Sp_",graph_1,"_",graph_2,"_",Detection,"_couleur.tiff",sep=""))
  saveData_noir<-file.path("Outcome","out-graph",
                           paste("RV_Sp_",graph_1,"_",graph_2,"_",Detection,"_noir_blanc.tiff",sep=""))
  ...
  if (Detection!="D5") {
    ...
    mtext(text ="a", side=2, line = 3.5, at=ylimG1[2], las=2 ,cex = 1.5)
    ...
    mtext(text ="b", side=2, line = 3.5, at=ylimG2[2], las=2 ,cex = 1.5)
