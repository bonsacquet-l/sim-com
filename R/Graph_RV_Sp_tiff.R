...
Fct_Graph_RV_Sp_tiff<-function(Detection="D1") {
  ...
  saveData_couleur<-file.path("Outcome","out-graph",
                              paste("RV_Sp_",Detection,"_couleur.tiff",sep=""))
  saveData_noir<-file.path("Outcome","out-graph",
                           paste("RV_Sp_",Detection,"_noir_blanc.tiff",sep=""))
  ...
  #-- Si ce n'est pas D5
  if (Detection!="D5") {
    tiff(file=saveData_couleur, units="in",width = 2.1, height = 5.2, pointsize = 7,res=300)
  ...
  #-- Si ce n'est pas D5
  if (Detection!="D5") {
    tiff(file=saveData_noir, units="in",width = 2.1, height = 5.2, pointsize = 7,res=300)
