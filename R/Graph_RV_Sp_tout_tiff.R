...
Fct_Graph_RV_Sp_tt_tiff<-function(Detection="D1") {
  ...
  if (Detection!="D5") {
    ...
    mtext(text ="a", side=2, line = 3.5, at=1, las=2 ,cex =1.6)
    ...
    mtext(text ="b", side=2, line = 3.5, at=1, las=2 ,cex =1.6)
    ...
    axis(1,at=c(20.5,23.5,26.5),labels = c("","C4",""),col="orange",
         col.axis="orange",lwd=1,cex.axis=1.3)
    mtext(text ="c", side=2, line = 3.5, at=1, las=2 ,cex =1.6)
    ...
    axis(1,at=c(20.5,23.5,26.5),labels = c("","C4",""),col="orange",
         col.axis="orange",lwd=1,cex.axis=1.3)
    mtext(text ="d", side=2, line = 3.5, at=1, las=2 ,cex =1.6)
    ...
    title(ylab=ylab5,line = 2.5,cex.lab=1.6)
    axis(1,at=c(0.5,3.5,6.5),labels = c("","C1",""),col="black",
         col.axis="black",lwd=1,cex.axis=1.3)
    axis(1,at=c(6.5,10,13.5),labels = c("","C2",""),col="red",
         col.axis="red",lwd=1,cex.axis=1.3)
    ...
    axis(1,at=c(20.5,23.5,26.5),labels = c("","C4",""),col="orange",
         col.axis="orange",lwd=1,cex.axis=1.3)
    mtext(text ="e", side=2, line = 3.5, at=1, las=2 ,cex =1.6)
    ...
    title(ylab=ylab6,line = 2.5,cex.lab=1.6)
    axis(1,at=c(0.5,3.5,6.5),labels = c("","C1",""),col="black",
         col.axis="black",lwd=1,cex.axis=1.3)
    axis(1,at=c(6.5,10,13.5),labels = c("","C2",""),col="red",
         col.axis="red",lwd=1,cex.axis=1.3)
    ...
    axis(1,at=c(20.5,23.5,26.5),labels = c("","C4",""),col="orange",
         col.axis="orange",lwd=1,cex.axis=1.3)
    mtext(text ="f", side=2, line = 3.5, at=1, las=2 ,cex =1.6)
