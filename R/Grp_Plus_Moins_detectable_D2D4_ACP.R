...
Fct_Grp_detect_ACP<-function() {
  ...
  M_Grp_Detect_Axe1_ACP<-matrix(NA,nrow = 11000,ncol = Nbr_Fichier)
  colnames(M_Grp_Detect_Axe1_ACP)<-as.character(c(V_Fichier_D2_GrpDetect,V_Fichier_D4_GrpDetect))
  
  M_Grp_Detect_Axe2_ACP<-matrix(NA,nrow = 11000,ncol = Nbr_Fichier)
  colnames(M_Grp_Detect_Axe2_ACP)<-as.character(c(V_Fichier_D2_GrpDetect,V_Fichier_D4_GrpDetect))
  
  M_Grp_Detect_Axe1_ACP_Naive<-matrix(NA,nrow = 11000,ncol = Nbr_Fichier)
  colnames(M_Grp_Detect_Axe1_ACP_Naive)<-as.character(c(V_Fichier_D2_GrpDetect,V_Fichier_D4_GrpDetect))
  
  M_Grp_Detect_Axe2_ACP_Naive<-matrix(NA,nrow = 11000,ncol = Nbr_Fichier)
  colnames(M_Grp_Detect_Axe2_ACP_Naive)<-as.character(c(V_Fichier_D2_GrpDetect,V_Fichier_D4_GrpDetect))
  ...
  for (n in c(V_Fichier_D2,V_Fichier_D4)) {
    ...
    while (i<=999) {
      ...
      M_Grp_Detect_Axe1_ACP[(lignes),paste(n,"_PlusD",sep="")]<-c(M_Resultat_Coord_Sp_ACP_axe1[Sp_les_Plus_Detect,n]*a,
                                                                  rep(median(M_Resultat_Coord_Sp_ACP_axe1[Sp_les_Plus_Detect,n])*a,2))
      ...
      M_Grp_Detect_Axe1_ACP_Naive[(lignes),paste(n,"_PlusD",sep="")]<-c(M_Resultat_Coord_Sp_ACP_Naive_axe1[Sp_les_Plus_Detect,n]*a,
                                                                        rep(median(M_Resultat_Coord_Sp_ACP_Naive_axe1[Sp_les_Plus_Detect,n])*a,2))
      ...
      M_Grp_Detect_Axe2_ACP[(lignes),paste(n,"_PlusD",sep="")]<-c(M_Resultat_Coord_Sp_ACP_axe2[Sp_les_Plus_Detect,n]*a,
                                                                  rep(median(M_Resultat_Coord_Sp_ACP_axe2[Sp_les_Plus_Detect,n])*a,2))
      ...
      M_Grp_Detect_Axe2_ACP_Naive[lignes,paste(n,"_PlusD",sep="")]<-c(M_Resultat_Coord_Sp_ACP_Naive_axe2[Sp_les_Plus_Detect,n]*a,
                                                                      rep(median(M_Resultat_Coord_Sp_ACP_Naive_axe2[Sp_les_Plus_Detect,n])*a,2))
  ...
  #-- sauvegarde
  saveData<-file.path("Outcome","out-regroupement","ACP","ACP_Grp_Detect.Rdata")
