...
Fct_Grp_detect_pcoa<-function(distance="chao") {
  ...
  M_Grp_Detect_Axe1_pcoa<-matrix(NA,nrow = 11000,ncol = Nbr_Fichier)
  colnames(M_Grp_Detect_Axe1_pcoa)<-as.character(c(V_Fichier_D2_GrpDetect,V_Fichier_D4_GrpDetect))
  
  M_Grp_Detect_Axe2_pcoa<-matrix(NA,nrow = 11000,ncol = Nbr_Fichier)
  colnames(M_Grp_Detect_Axe2_pcoa)<-as.character(c(V_Fichier_D2_GrpDetect,V_Fichier_D4_GrpDetect))
  
  M_Grp_Detect_Axe1_pcoa_Naive<-matrix(NA,nrow = 11000,ncol = Nbr_Fichier)
  colnames(M_Grp_Detect_Axe1_pcoa_Naive)<-as.character(c(V_Fichier_D2_GrpDetect,V_Fichier_D4_GrpDetect))
  
  M_Grp_Detect_Axe2_pcoa_Naive<-matrix(NA,nrow = 11000,ncol = Nbr_Fichier)
  colnames(M_Grp_Detect_Axe2_pcoa_Naive)<-as.character(c(V_Fichier_D2_GrpDetect,V_Fichier_D4_GrpDetect))
  ...
  #-- sauvegarde
  saveData<-file.path("Outcome","out-regroupement","PCoA",paste("PCoA_",distance,"_Grp_Detect.Rdata",sep = ""))
