...
# medianes pour les indicateurs des ACP    #
...
#-- les ACP
  ...
  data<-as.tibble(M_Resultat_RV_ACP_good)
  ...
  T_median<-bind_cols(tibble(analyse="RV_ACP"),T_median_RV)
    
  #-- les groupe 1 et 2
  load(file.path("Outcome","out-regroupement","ACP","ACP_Grp_1_2_good.Rdata"))
  
  data<-as.tibble(M_Grp_1_2_Axe1_ACP_good)
  ...
  data<-as.tibble(M_Grp_1_2_Axe2_ACP_good)
  ...
  data<-as.tibble(M_Grp_1_2_Axe1_ACP_Naive_good)
  ...
  data<-as.tibble(M_Grp_1_2_Axe2_ACP_Naive_good)
  ...
  data<-as.tibble(M_Grp_A_B_Axe1_ACP_good)
  ...
  data<-as.tibble(M_Grp_A_B_Axe2_ACP_good)
  ...
  data<-as.tibble(M_Grp_A_B_Axe1_ACP_Naive_good)
  ...
  data<-as.tibble(M_Grp_A_B_Axe2_ACP_Naive_good)
  ...
  data<-as.tibble(M_Grp_Detect_Axe1_ACP_good)
  ...
  #--axes2
  load(file.path("Outcome","out-regroupement","ACP","ACP_Grp_Detect_good.Rdata"))
  data<-as.tibble(M_Grp_Detect_Axe2_ACP_good)
  ...
  #--axes1 naif
  load(file.path("Outcome","out-regroupement","ACP","ACP_Grp_Detect_good.Rdata"))
  data<-as.tibble(M_Grp_Detect_Axe1_ACP_Naive_good)
  ...
  #--axes2 naif
  load(file.path("Outcome","out-regroupement","ACP","ACP_Grp_Detect_good.Rdata"))
  data<-as.tibble(M_Grp_Detect_Axe2_ACP_Naive_good)
...
#-- Sauvegarde de la table pour les ACP et en fonction de la detection
  ...
  saveData<-file.path("Outcome","out_median","T_median_ACP.Rdata")
  ...
  write_excel_csv2(T_median_D1,file.path("Outcome","out_median","T_median_D1_ACP.csv"))
  write_excel_csv2(T_median_D2,file.path("Outcome","out_median","T_median_D2_ACP.csv"))
  write_excel_csv2(T_median_D3,file.path("Outcome","out_median","T_median_D3_ACP.csv"))
  write_excel_csv2(T_median_D4,file.path("Outcome","out_median","T_median_D4_ACP.csv"))
  write_excel_csv2(T_median_D5,file.path("Outcome","out_median","T_median_D5_ACP.csv"))
