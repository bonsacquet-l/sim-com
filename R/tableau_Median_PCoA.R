...
# medianes pour les indicateurs des PCoA_bray   #
# et PCoA_chao puis les inscrire dans           #
...
data<-as.tibble(M_Resultat_RV_pcoa_good)
...
T_median<-bind_cols(tibble(analyse="RV_PCoA_bray"),T_median_RV)

#-- les groupe 1 et 2
load(file.path("Outcome","out-regroupement","PCoA","PCoA_bray_Grp_1_2_good.Rdata"))

data<-as.tibble(M_Grp_1_2_Axe1_pcoa_good)
...
data<-as.tibble(M_Grp_1_2_Axe2_pcoa_good)
...
data<-as.tibble(M_Grp_1_2_Axe1_pcoa_Naive_good)
...
data<-as.tibble(M_Grp_1_2_Axe2_pcoa_Naive_good)
...
data<-as.tibble(M_Grp_A_B_Axe1_pcoa_good)
...
data<-as.tibble(M_Grp_A_B_Axe2_pcoa_good)
...
data<-as.tibble(M_Grp_A_B_Axe1_pcoa_Naive_good)
...
data<-as.tibble(M_Grp_A_B_Axe2_pcoa_Naive_good)
...
data<-as.tibble(M_Grp_Detect_Axe1_pcoa_good)
...
#--axes2
load(file.path("Outcome","out-regroupement","PCoA","PCoA_bray_Grp_Detect_good.Rdata"))
data<-as.tibble(M_Grp_Detect_Axe2_pcoa_good)
...
#--axes1 naif
load(file.path("Outcome","out-regroupement","PCoA","PCoA_bray_Grp_Detect_good.Rdata"))
data<-as.tibble(M_Grp_Detect_Axe1_pcoa_Naive_good)
...
#--axes2 naif
load(file.path("Outcome","out-regroupement","PCoA","PCoA_bray_Grp_Detect_good.Rdata"))
data<-as.tibble(M_Grp_Detect_Axe2_pcoa_Naive_good)
...
#-- Sauvegarde de la table pour les PCoA et en fonction de la detection
...
saveData<-file.path("Outcome","out_median","T_median_PCoA_bray.Rdata")
...
write_excel_csv2(T_median_D1,file.path("Outcome","out_median","T_median_D1_PCoA_bray.csv"))
write_excel_csv2(T_median_D2,file.path("Outcome","out_median","T_median_D2_PCoA_bray.csv"))
write_excel_csv2(T_median_D3,file.path("Outcome","out_median","T_median_D3_PCoA_bray.csv"))
write_excel_csv2(T_median_D4,file.path("Outcome","out_median","T_median_D4_PCoA_bray.csv"))
write_excel_csv2(T_median_D5,file.path("Outcome","out_median","T_median_D5_PCoA_bray.csv"))
...
T_median<-bind_cols(tibble(analyse="RV_PCoA_chao"),T_median_RV)
...
#-- chemin de sauvegarde en R.data
saveData<-file.path("Outcome","out_median","T_median_PCoA_chao.Rdata")
...
#-- chemin de sauvegarde en .csv
write_excel_csv2(T_median_D1,file.path("Outcome","out_median","T_median_D1_PCoA_chao.csv"))
write_excel_csv2(T_median_D2,file.path("Outcome","out_median","T_median_D2_PCoA_chao.csv"))
write_excel_csv2(T_median_D3,file.path("Outcome","out_median","T_median_D3_PCoA_chao.csv"))
write_excel_csv2(T_median_D4,file.path("Outcome","out_median","T_median_D4_PCoA_chao.csv"))
write_excel_csv2(T_median_D5,file.path("Outcome","out_median","T_median_D5_PCoA_chao.csv"))
