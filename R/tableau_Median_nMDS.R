...
# medianes pour les indicateurs des nMDS_bray   #
# et nMDS_chao puis les inscrire dans           #
# un tableau Rdata et csv                       #
#-----------------------------------------------#
#
#-- nettoyage
rm(list = (ls()))
...
data<-as.tibble(M_Resultat_RV_nmds_good)
...
T_median<-bind_cols(tibble(analyse="RV_nMDS_bray"),T_median_RV)

#-- les groupe 1 et 2
load(file.path("Outcome","out-regroupement","nMDS","nMDS_bray_Grp_1_2_good.Rdata"))

data<-as.tibble(M_Grp_1_2_Axe1_nmds_good)
...
data<-as.tibble(M_Grp_1_2_Axe2_nmds_good)
...
data<-as.tibble(M_Grp_1_2_Axe1_nmds_Naive_good)
...
data<-as.tibble(M_Grp_1_2_Axe2_nmds_Naive_good)
...
data<-as.tibble(M_Grp_A_B_Axe1_nmds_good)
...
data<-as.tibble(M_Grp_A_B_Axe2_nmds_good)
...
data<-as.tibble(M_Grp_A_B_Axe1_nmds_Naive_good)
...
data<-as.tibble(M_Grp_A_B_Axe2_nmds_Naive_good)
...
data<-as.tibble(M_Grp_Detect_Axe1_nmds_good)
...
#--axes2
load(file.path("Outcome","out-regroupement","nMDS","nMDS_bray_Grp_Detect_good.Rdata"))
data<-as.tibble(M_Grp_Detect_Axe2_nmds_good)
...
#--axes1 naif
load(file.path("Outcome","out-regroupement","nMDS","nMDS_bray_Grp_Detect_good.Rdata"))
data<-as.tibble(M_Grp_Detect_Axe1_nmds_Naive_good)
...
#--axes2 naif
load(file.path("Outcome","out-regroupement","nMDS","nMDS_bray_Grp_Detect_good.Rdata"))
data<-as.tibble(M_Grp_Detect_Axe2_nmds_Naive_good)
...
#-- Sauvegarde de la table pour les nMDS et en fonction de la detection
...
saveData<-file.path("Outcome","out_median","T_median_nMDS_bray.Rdata")
...
write_excel_csv2(T_median_D1,file.path("Outcome","out_median","T_median_D1_nMDS_bray.csv"))
write_excel_csv2(T_median_D2,file.path("Outcome","out_median","T_median_D2_nMDS_bray.csv"))
write_excel_csv2(T_median_D3,file.path("Outcome","out_median","T_median_D3_nMDS_bray.csv"))
write_excel_csv2(T_median_D4,file.path("Outcome","out_median","T_median_D4_nMDS_bray.csv"))
write_excel_csv2(T_median_D5,file.path("Outcome","out_median","T_median_D5_nMDS_bray.csv"))
...
T_median<-bind_cols(tibble(analyse="RV_nMDS_chao"),T_median_RV)
...
#-- chemin de sauvegarde en R.data
saveData<-file.path("Outcome","out_median","T_median_nMDS_chao.Rdata")
...
#-- chemin de sauvegarde en .csv
write_excel_csv2(T_median_D1,file.path("Outcome","out_median","T_median_D1_nMDS_chao.csv"))
write_excel_csv2(T_median_D2,file.path("Outcome","out_median","T_median_D2_nMDS_chao.csv"))
write_excel_csv2(T_median_D3,file.path("Outcome","out_median","T_median_D3_nMDS_chao.csv"))
write_excel_csv2(T_median_D4,file.path("Outcome","out_median","T_median_D4_nMDS_chao.csv"))
write_excel_csv2(T_median_D5,file.path("Outcome","out_median","T_median_D5_nMDS_chao.csv"))
